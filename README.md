# Angular Boot Camp example: video-stack-tracker
...
**[StackBlitz for video-stack-tracker](https://stackblitz.io/github/AngularBootCamp/video-stack-tracker)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/video-stack-tracker.git
cd video-stack-tracker
npm install
npm start
```
